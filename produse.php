...
<div class="container-cat_prod">
    ...
    <?php
        ...
        /*For filter reasch here*/
        if(isset($_GET['searchFilter']))
        {
            $filter = $_GET['searchFilter'];
            
            $sql = "SELECT * FROM produse WHERE nume_produs LIKE '%$filter%'";
            $result = mysqli_query($conn, $sql);
            
            echo '<p style="color:#ccc; font-size:16px; font-weight:bold; letter-spacing:1.08px">Search result:</p><br>';
